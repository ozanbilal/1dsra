...
| `opensees-parity` | 6 | dedicated OpenSees parity envelope (`parity01..06`) | explicit locked checks + solver diagnostic constraints + dt-sensitivity gates | `pending_release_sha256` | `2026-03-04T00:00:00Z` | Medium | Replace with dedicated-runner observed sha256 before tagging release; machine-check enforces exact match |
