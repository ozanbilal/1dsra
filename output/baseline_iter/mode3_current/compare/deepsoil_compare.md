# DEEPSOIL Comparison: run-2ef16c347d21

## Inputs
- GeoWave run: `output\baseline_iter\mode3_current\run-2ef16c347d21`
- DEEPSOIL workbook: `tests\Results_profile_0_motion_Kocaeli.xlsx`
- DEEPSOIL surface CSV: `output\baseline_iter\mode3_current\compare\_deepsoil_bundle\surface.csv`
- DEEPSOIL input motion CSV: `output\baseline_iter\mode3_current\compare\_deepsoil_bundle\input_motion.csv`
- DEEPSOIL PSA source: `output\baseline_iter\mode3_current\compare\_deepsoil_bundle\psa_surface.csv`
- DEEPSOIL input PSA source: `output\baseline_iter\mode3_current\compare\_deepsoil_bundle\psa_input.csv`
...
- PGA (GeoWave): `2.615135` m/s^2
- PGA (DEEPSOIL): `3.016121` m/s^2
- PGA ratio: `0.867053`
- PGA diff: `-13.295` %
- Surface RMSE: `0.297709` m/s^2
- Surface NRMSE: `0.098706`
- Surface correlation: `0.767557`

## PSA
- PSA points compared: `80`
- PSA RMSE: `0.799379` m/s^2
- PSA NRMSE: `0.071089`
- PSA max abs diff: `2.639382` m/s^2
- PSA diff at reference peak: `-17.009` %
...
## Profile
- Profile CSV: `output\baseline_iter\mode3_current\compare\_deepsoil_bundle\profile.csv`
- Mobilized strength CSV: `output\baseline_iter\mode3_current\compare\_deepsoil_bundle\mobilized_strength.csv`
...
- PGA-vs-depth NRMSE: `0.10435880316401804`
- Max displacement NRMSE: `0.34541421104246733`
- Max strain NRMSE: `0.14464029225429245`
- Max stress ratio NRMSE: `0.516747210145937`
- Vs NRMSE: `None`
- Implied strength NRMSE: `None`
- Normalized implied strength NRMSE: `None`
- Implied friction angle NRMSE: `None`
- Mobilized strength NRMSE: `0.10232834869925202`
- Mobilized friction angle NRMSE: `0.49138680872058244`

## Layer-by-Layer Parity
- Layer rows compared: `5`
- gamma_max NRMSE: `0.14464029225429248`
- tau_peak NRMSE: `0.10232834869925202`
- Secant G/Gmax NRMSE: `0.16772921218927922`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| L1 | 2.000 | 4.893098e-05 | 2.925981e-05 | 67.229 | 10.651191 | 12.100000 | -11.974 | 0.679984 | 0.811359 | -16.192 | 0.288145 | 139.829 |
| L2 | 6.000 | 1.372112e-04 | 1.023814e-04 | 34.020 | 31.386616 | 36.100000 | -13.056 | 0.556343 | 0.691808 | -19.581 |  |  |
| L3 | 10.000 | 2.386578e-04 | 1.855473e-04 | 28.624 | 49.812544 | 57.600000 | -13.520 | 0.467694 | 0.609069 | -23.212 |  |  |
| L4 | 14.000 | 3.178251e-04 | 2.599750e-04 | 22.252 | 63.774881 | 74.700000 | -14.625 | 0.424708 | 0.563752 | -24.664 |  |  |
| L5 | 18.000 | 3.436857e-04 | 3.017603e-04 | 13.894 | 71.744739 | 84.900000 | -15.495 | 0.419077 | 0.552007 | -24.081 |  |  |
...
- Recorded loop diff %: `139.8288639695613`
- Stress-path NRMSE: `0.28814503592641405`
- Backbone loop closer than recorded loop: `False`
- Recorded envelope tau NRMSE: `0.04337025643301369`
- Backbone envelope tau NRMSE: `0.021648510501363877`
- Recorded envelope secant NRMSE: `0.22145938744855154`
...
## Hysteresis
- Hysteresis CSV: `output\baseline_iter\mode3_current\compare\_deepsoil_bundle\hysteresis_layer1.csv`
- Layer index: `0`
- Resampled points: `240`
- sw gamma_peak: `2.399009e-05`
- ref gamma_peak: `2.686004e-05`
- Stress-path NRMSE: `0.288145`
- sw loop energy: `2.745850e-04`
- ref loop energy: `1.144921e-04`
- Loop energy diff: `139.829` %
- sw tau_peak: `8.311899` kPa
- ref tau_peak: `10.957557` kPa
- tau_peak diff: `-24.145` %
- gamma_peak diff: `-10.685` %
