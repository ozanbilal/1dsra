# DEEPSOIL Comparison: run-45830822d007

## Inputs
- StrataWave run: `H:\Drive'ım\GitHub_Repo\Deepsoil\1DSRA\output\pdf\validation\deepsoil_examples\reload_substeps_sweep\substeps_24\run-45830822d007`
...
- PGA (StrataWave): `5.706498` m/s^2
- PGA (DEEPSOIL): `18.052400` m/s^2
- PGA ratio: `0.316107`
- PGA diff: `-68.389` %
- Surface RMSE: `7.877339` m/s^2
- Surface NRMSE: `0.436360`
- Surface correlation: `-0.001530`

## PSA
- PSA points compared: `80`
- PSA RMSE: `7.860519` m/s^2
- PSA NRMSE: `0.193911`
- PSA max abs diff: `32.955667` m/s^2
- PSA diff at reference peak: `-81.298` %
