# DEEPSOIL Comparison: run-cf0e98362f1c

## Inputs
- StrataWave run: `H:\Drive'ım\GitHub_Repo\Deepsoil\1DSRA\output\pdf\validation\deepsoil_examples\reload_sweep\rf_1p0\run-cf0e98362f1c`
...
- PGA (StrataWave): `3.927235` m/s^2
- PGA (DEEPSOIL): `18.052400` m/s^2
- PGA ratio: `0.217546`
- PGA diff: `-78.245` %
- Surface RMSE: `7.845923` m/s^2
- Surface NRMSE: `0.434619`
- Surface correlation: `0.000619`

## PSA
- PSA points compared: `80`
- PSA RMSE: `8.428723` m/s^2
- PSA NRMSE: `0.207928`
- PSA max abs diff: `33.612006` m/s^2
- PSA diff at reference peak: `-82.917` %
