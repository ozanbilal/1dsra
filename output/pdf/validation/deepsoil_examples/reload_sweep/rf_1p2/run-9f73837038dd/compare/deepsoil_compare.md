# DEEPSOIL Comparison: run-9f73837038dd

## Inputs
- StrataWave run: `H:\Drive'ım\GitHub_Repo\Deepsoil\1DSRA\output\pdf\validation\deepsoil_examples\reload_sweep\rf_1p2\run-9f73837038dd`
...
- PGA (StrataWave): `3.908698` m/s^2
- PGA (DEEPSOIL): `18.052400` m/s^2
- PGA ratio: `0.216520`
- PGA diff: `-78.348` %
- Surface RMSE: `7.860033` m/s^2
- Surface NRMSE: `0.435401`
- Surface correlation: `0.004517`

## PSA
- PSA points compared: `80`
- PSA RMSE: `8.259563` m/s^2
- PSA NRMSE: `0.203755`
- PSA max abs diff: `33.658124` m/s^2
- PSA diff at reference peak: `-83.031` %
