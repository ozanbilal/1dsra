# DEEPSOIL Comparison: run-0aee7db94924

## Inputs
- StrataWave run: `H:\Drive'ım\GitHub_Repo\Deepsoil\1DSRA\output\pdf\validation\deepsoil_examples\reload_sweep_fine\rf_1p6\run-0aee7db94924`
...
- PGA (StrataWave): `6.379359` m/s^2
- PGA (DEEPSOIL): `18.052400` m/s^2
- PGA ratio: `0.353380`
- PGA diff: `-64.662` %
- Surface RMSE: `7.887712` m/s^2
- Surface NRMSE: `0.436934`
- Surface correlation: `-0.001385`

## PSA
- PSA points compared: `80`
- PSA RMSE: `7.903401` m/s^2
- PSA NRMSE: `0.194969`
- PSA max abs diff: `32.601148` m/s^2
- PSA diff at reference peak: `-80.424` %
