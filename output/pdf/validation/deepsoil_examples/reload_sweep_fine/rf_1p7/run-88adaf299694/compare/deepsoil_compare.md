# DEEPSOIL Comparison: run-88adaf299694

## Inputs
- StrataWave run: `H:\Drive'ım\GitHub_Repo\Deepsoil\1DSRA\output\pdf\validation\deepsoil_examples\reload_sweep_fine\rf_1p7\run-88adaf299694`
...
- PGA (StrataWave): `6.823447` m/s^2
- PGA (DEEPSOIL): `18.052400` m/s^2
- PGA ratio: `0.377980`
- PGA diff: `-62.202` %
- Surface RMSE: `7.894955` m/s^2
- Surface NRMSE: `0.437335`
- Surface correlation: `-0.001854`

## PSA
- PSA points compared: `80`
- PSA RMSE: `7.952511` m/s^2
- PSA NRMSE: `0.196181`
- PSA max abs diff: `32.320349` m/s^2
- PSA diff at reference peak: `-79.731` %
